...
export declare class SendMessageWhatsappService extends BaseService<SendMessageWhatsApp> {
    private metaService;
    private whatsAppService;
    constructor(metaService: MetaService, whatsAppService: WhatsappOficialService);
    private createFile;
    private getIdMetaMedia;
    createMessage(token: string, dados_mensagem: string, file: Express.Multer.File): Promise<{
    ...
    readMessage(token: string, messageId: string): Promise<import("src/@core/infra/meta/interfaces/IMeta.interfaces").IResultTemplates>;
}
